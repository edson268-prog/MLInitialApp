...
namespace MLInitialApp_Console
{
    public partial class PredictiveModel
    {
        public const string RetrainFilePath =  @"G:\Programming\Artificial_Intelligence\MLInitialApp\MLInitialApp.Console\files\MLData.csv";
